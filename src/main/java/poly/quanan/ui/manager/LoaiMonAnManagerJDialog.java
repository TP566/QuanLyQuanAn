...
import poly.quanan.ui.manager.LoaiMonAnController;
 ...
 * @author lengh
 */
public class LoaiMonAnManagerJDialog extends javax.swing.JDialog implements LoaiMonAnController {

    /**
     * Creates new form LoaiGaoManagerJDialog
     */
    public LoaiMonAnManagerJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoaiMonAnManagerJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoaiMonAnManagerJDialog dialog = new LoaiMonAnManagerJDialog(new javax.swing.JFrame(), true);
...
LoaiMonAnDAO dao = new LoaiMonAnDAOImpl();
List<LoaiMonAn> items = List.of();
...
@Override
public void edit() {
    LoaiMonAn entity = items.get(tblCategories.getSelectedRow());
    this.setForm(entity);
    ...
    if (XDialog.confirm("Bạn thực sự muốn xóa các mục chọn?")) {
        for (int i = 0; i < tblCategories.getRowCount(); i++) {
            if ((Boolean) tblCategories.getValueAt(i, 2)) {
                dao.deleteById(items.get(i).getMaDanhMuc());
            }
        }
        this.fillToTable();
    }
...
@Override
public void setForm(LoaiMonAn entity) {
    txtId.setText(entity.getMaDanhMuc());
    txtName.setText(entity.getTenDanhMuc());
}

@Override
public LoaiMonAn getForm() {
    LoaiMonAn entity = new LoaiMonAn();
    entity.setMaDanhMuc(txtId.getText());
    entity.setTenDanhMuc(txtName.getText());
    return entity;
}

@Override
public void create() {
    LoaiMonAn entity = this.getForm();
    dao.create(entity);
    this.fillToTable();
    this.clear();
}
...
public void setEditable(boolean editable) {
    ...
    // các nút điều hướng nếu có, cũng tạo tương tự
}
...
void showDetail(int row) {
    String maDanhMuc = tblCategories.getValueAt(row, 0).toString();
    String tenDanhMuc = tblCategories.getValueAt(row, 1).toString();

    txtId.setText(maDanhMuc);
    txtName.setText(tenDanhMuc);
}
}