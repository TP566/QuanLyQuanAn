...
public class LichSuJDialog extends javax.swing.JDialog implements LichSuController {
    ...
    public void fillBills() {
        ...
        bills = hoadonDao.findByUserAndTimeRange(username, begin, end);
        ...
        bills.forEach(b -> {
            Object[] row = {
                b.getMaHd(),
                "Card #" + b.getCardId(),
                XDate.format(b.getThoiGianVao(), "HH:mm:ss dd-MM-yyyy"),
                XDate.format(b.getThoiGianRa(), "HH:mm:ss dd-MM-yyyy"),
                statuses[b.getTrangThai()]
            };
            model.addRow(row);
        });
    }
    ...
    public void showBillJDialog() {
        HoaDon bill = bills.get(tblBills.getSelectedRow());
        HoaDonJDialog dialog = new HoaDonJDialog((Frame) this.getOwner(), true);
        dialog.setHoaDon(bill); // truyền bill vào cửa sổ BillJDialog
        dialog.setVisible(true);
        dialog.addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
